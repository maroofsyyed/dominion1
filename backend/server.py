...
async def initialize_exercises():
    ...
    exercises_data = [
        ...
        # Horizontal Push - Intermediate
        {"name": "Pseudo Planche Push Up", "pillar": "Horizontal Push", "skill_level": "Intermediate", "description": "Push up with hands turned out and shoulders forward.", "instructions": ["Fingers pointing to feet", "Lean forward", "Keep shoulders protracted"], "common_mistakes": ["Not leaning enough", "Collapsing shoulders"], "progression_order": 4},
        {"name": "Ring Push Up", "pillar": "Horizontal Push", "skill_level": "Intermediate", "description": "Push up performed on gymnastic rings.", "instructions": ["Rings at push up height", "Lower with control", "Stabilize throughout"], "common_mistakes": ["Rings turning out", "Losing stability"], "progression_order": 5},
